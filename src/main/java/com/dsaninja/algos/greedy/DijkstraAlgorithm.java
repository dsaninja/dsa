...
public class DijkstraAlgorithm{
    ...
    public int traverse(int[][] graph, int start, int end, Consumer<Integer> consumer){
        //TODO convert to record once jacoco supports the coverage
        class Node{
            final int vertexId; final int weight;
        ...
        Queue<Node> priorityQueue = new PriorityQueue<>(Comparator.comparing(Node::getWeight));
